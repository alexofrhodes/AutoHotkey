;Alex: modified line 495 regarding button caption
...
Class ImageButton {
   ...
   ; PUBLIC METHODS ====================================================================================================
   ; ===================================================================================================================
   Create(HWND, BtnCaption, Options*) {
      ; Windows constants
      ...
      ; ControlSetText, , , ahk_id %HWND%             ;<----- Alex: I commented this out because i make use of button's caption to call macros
